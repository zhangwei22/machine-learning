...
def testRbf(k1=1.3):
    dataArr, labelArr = loadData('source_code/Ch06/testSetRBF.txt')
    ...
    dataArr, labelArr = loadData('source_code/Ch06/testSetRBF2.txt')
    errorCount = 0
    datMat = mat(dataArr);
    labelMat = mat(labelArr).transpose()
    m, n = shape(datMat)
...
def testDigits(kTup=('rbf', 10)):
    dataArr, labelArr = loadImages('source_code/Ch06/digits/trainingDigits')
